...
![Pasted image 20251115093713.png](/images/bayesian-meta-analysis/Pasted%20image%2020251115093713.png)
...
2. 后验预测检查
	...
	2. ```r
	   pp_check(m.brm)
	   ```
![Pasted image 20251115165052.png](/images/bayesian-meta-analysis/Pasted%20image%2020251115165052.png)
...
![Pasted image 20251116220616.png](/images/bayesian-meta-analysis/Pasted%20image%2020251116220616.png)
...
![Pasted image 20251116220546.png](/images/bayesian-meta-analysis/Pasted%20image%2020251116220546.png)
...
ggplot(aes(x = tau), data = post.samples) +
  ...
  theme_minimal()
```
![posterior_plot 3.png](/images/bayesian-meta-analysis/posterior_plot%203.png)
...
> [1] 0.002125
```
![P_smd_0.3.png](/images/bayesian-meta-analysis/P_smd_0.3.png)
...
ggplot(aes(b_Intercept, 
  ...
  theme_bw()
```
![Pasted image 20251116231904.png](/images/bayesian-meta-analysis/Pasted%20image%2020251116231904.png)
...
1. [和DwR的教程很相似的部分，绘制了总体效应量 和 研究间异质性，以及研究内的异质性的后验分布，考虑到了效应量间的异质性（三水平层次模型）；计算了累计概率曲线；研究效应量提取也可借鉴](https://www.nature.com/articles/s44271-024-00124-2)
	- [原文PDF](/files/bayesian-meta-analysis/%E8%B4%9D%E5%8F%B6%E6%96%AF%E8%8C%83%E6%96%87.pdf)
![Pasted image 20251117014856.png](/images/bayesian-meta-analysis/Pasted%20image%2020251117014856.png)
