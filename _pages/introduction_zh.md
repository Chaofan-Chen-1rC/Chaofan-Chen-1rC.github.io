...
Cochrane 会发布定期更新的 [《干预系统综述手册》](https://training.cochrane.org/handbook)（Julian Higgins et al., 2019）以及 [Cochrane 偏倚风险工具](https://methods.cochrane.org/risk-bias-2)（Sterne et al., 2019）。这两者都被广泛认为是系统综述与 Meta 分析技术细节方面的标准参考文献（见第 1.4 章）。
...
如果你在生物医学研究中进行 Meta 分析，或者研究的是某种干预的效果，我们强烈建议你遵循 PRISMA，即 [系统综述与 Meta 分析优先报告项目](https://www.prisma-statement.org/)（Moher et al., 2009）。PRISMA 声明对 Meta 分析过程中几乎所有环节应如何报告给出了若干建议。
...
如果你的研究只纳入随机对照试验，那么评估研究质量的最佳方式之一，是使用 Cochrane 开发的 [Risk of Bias Tool](https://methods.cochrane.org/risk-bias-2)（Julian Higgins et al., 2011；Sterne et al., 2019）。正如其名称所示，这个工具评估的并不是研究“质量”本身，而是研究的“偏倚风险”。
...
在多个维度上，偏倚风险工具允许你把某项研究的偏倚风险分类为“高”或“低”，或者判定为“存在一些担忧”。关于如何在视觉上总结偏倚风险，也有相应惯例（见第 15 章，我们会介绍如何在 R 中实现）。对于非随机研究，类似的资源是 [ROBINS-I](https://www.riskofbias.info/) 工具，即 *Risk of Bias in Non-randomized Studies of Interventions*（Sterne et al., 2016）。
